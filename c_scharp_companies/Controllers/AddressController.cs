...
namespace c_scharp_companies.Controllers
{
    public class AddressController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] Address address)
        {
            if (id != address.Id)
            {
                return NotFound();
